package net.kjani.sapphireitems.item.custom;

import com.google.common.collect.ImmutableListMultimap;
import net.kjani.sapphireitems.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private void evaluateArmorEffects(Player player) {
        for (ArmorMaterial material : MATERIAL_TO_EFFECT_MAP.keySet()) {
            if (hasCorrectArmorOn(material, player)) {
                List<MobEffectInstance> effects = MATERIAL_TO_EFFECT_MAP.get(material);
